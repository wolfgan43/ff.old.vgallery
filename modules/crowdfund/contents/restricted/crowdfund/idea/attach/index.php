...
$oRecord->title = ffTemplate::_get_word_by_code("crowdfund_idea_attach") . " - " . $idea_name;
...
$oGrid->id = "Attach";
//$oGrid->title = ffTemplate::_get_word_by_code("attach_title");
$oGrid->source_SQL = "SELECT
                            " . CM_TABLE_PREFIX . "mod_crowdfund_idea_attach.*
                        FROM
                            " . CM_TABLE_PREFIX . "mod_crowdfund_idea_attach
...
$oField->label = ffTemplate::_get_word_by_code("crowdfund_attach_file");
...
$oField->label = ffTemplate::_get_word_by_code("crowdfund_attach_name");
$oGrid->addContent($oField);

$oField = ffField::factory($cm->oPage);
$oField->id = "last_update";
$oField->container_class = "last_update";
$oField->label = ffTemplate::_get_word_by_code("crowdfund_attach_last_update");
