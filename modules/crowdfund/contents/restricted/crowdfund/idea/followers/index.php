...
$oRecord->title = ffTemplate::_get_word_by_code("crowdfund_idea_followers") . " - " . $idea_name;
...
$oGrid->id = "Followers";
//$oGrid->title = ffTemplate::_get_word_by_code("followers_title");
$oGrid->source_SQL = "SELECT
                            " . CM_TABLE_PREFIX . "mod_crowdfund_idea_followers.*
                            , anagraph.avatar
                            , anagraph.email
...
$oGrid->record_id = "FollowersModify";
$oGrid->resources[] = $oGrid->record_id;
$oGrid->display_new = $permission[global_settings("MOD_CROWDFUND_GROUP_ADMIN")];
$oGrid->display_edit_bt = false;
$oGrid->display_edit_url = $permission[global_settings("MOD_CROWDFUND_GROUP_ADMIN")];
$oGrid->display_delete_bt = $permission[global_settings("MOD_CROWDFUND_GROUP_ADMIN")];
$oGrid->addEvent("on_before_parse_row", "followers_on_before_parse_row");
...
$oField->label = ffTemplate::_get_word_by_code("crowdfund_followers_avatar");
...
$oField->label = ffTemplate::_get_word_by_code("crowdfund_followers_last_update");
...
$oField->label = ffTemplate::_get_word_by_code("crowdfund_followers_anagraph");
$oGrid->addContent($oField);
...
function followers_on_before_parse_row($component) {
