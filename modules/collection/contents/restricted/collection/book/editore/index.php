...
$oGrid->id = "edizione";
$oGrid->title = ffTemplate::_get_word_by_code("mod_collection_book_edizione_grid_title");
$oGrid->source_SQL = "SELECT " . CM_TABLE_PREFIX . "mod_collection_book_editore.*
...
$oGrid->record_id = "bookEditoreModify";
