...
$oGrid->id = "author";
$oGrid->title = ffTemplate::_get_word_by_code("mod_collection_book_author_grid_title");
$oGrid->source_SQL = "SELECT " . CM_TABLE_PREFIX . "mod_collection_book_author.*
...
$oGrid->record_id = "bookAuthorModify";
...
$oField = ffField::factory($cm->oPage);
$oField->id = "name";
$oField->label = ffTemplate::_get_word_by_code("mod_collection_book_author_name");
