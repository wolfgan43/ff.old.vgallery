...
$oGrid->id = "genre";
$oGrid->title = ffTemplate::_get_word_by_code("mod_collection_film_genre_grid_title");
$oGrid->source_SQL = "SELECT " . CM_TABLE_PREFIX . "mod_collection_film_genre.*
...
$oGrid->record_id = "filmGenreModify";
