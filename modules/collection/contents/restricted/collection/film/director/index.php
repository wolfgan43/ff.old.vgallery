...
$oGrid->id = "director";
$oGrid->title = ffTemplate::_get_word_by_code("mod_collection_film_director_grid_title");
$oGrid->source_SQL = "SELECT " . CM_TABLE_PREFIX . "mod_collection_film_director.*
...
$oGrid->record_id = "filmDirectorModify";
