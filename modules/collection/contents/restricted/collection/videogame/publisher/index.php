...
$oGrid->id = "publisher";
$oGrid->title = ffTemplate::_get_word_by_code("mod_collection_videogame_publisher_grid_title");
$oGrid->source_SQL = "SELECT " . CM_TABLE_PREFIX . "mod_collection_videogame_publisher.*
...
$oGrid->record_id = "videogamePublisherModify";
