...
$oGrid->source_SQL = "SELECT
                        ...
                        FROM
                            " . CM_TABLE_PREFIX . "mod_phonecall_message
                        WHERE NOT(" . CM_TABLE_PREFIX . "mod_phonecall_message.status > 0)
                        	$sSQL_Where
                        [AND] [WHERE] 
                        [HAVING]
                        [ORDER]";
...
$cm->oPage->addContent($oGrid, "rel", null, array("title" => ffTemplate::_get_word_by_code("phonecall_pending"))); 
...
$cm->oPage->addContent($oGrid, "rel", null, array("title" => ffTemplate::_get_word_by_code("phonecall_pending_owned"))); 
?>