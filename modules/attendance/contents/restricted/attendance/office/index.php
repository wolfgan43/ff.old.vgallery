...
$oGrid->id = "office";
$oGrid->title = ffTemplate::_get_word_by_code("office_title");
$oGrid->source_SQL = "SELECT
                            " . CM_TABLE_PREFIX . "mod_attendance_office.*
                        FROM
                            " . CM_TABLE_PREFIX . "mod_attendance_office
                        WHERE 1
                        [AND] [WHERE] 
...
$oField = ffField::factory($cm->oPage);
$oField->id = "name";
$oField->label = ffTemplate::_get_word_by_code("office_name");
