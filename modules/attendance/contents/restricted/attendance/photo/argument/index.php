...
$oGrid->id = "argument";
$oGrid->title = ffTemplate::_get_word_by_code("photo_argument_title");
$oGrid->source_SQL = "SELECT
                            " . CM_TABLE_PREFIX . "mod_attendance_photo_argument.*
                        FROM
                            " . CM_TABLE_PREFIX . "mod_attendance_photo_argument
                        WHERE 1
                        [AND] [WHERE] 
...
$oGrid->record_id = "PhotoArgumentModify";
...
$oField = ffField::factory($cm->oPage);
$oField->id = "name";
$oField->label = ffTemplate::_get_word_by_code("photo_argument_name");
