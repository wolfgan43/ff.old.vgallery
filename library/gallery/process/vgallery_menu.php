	...
	*/	
    ...
    if(is_array($part_item) && count($part_item)) {
        ...
        if($show_home) {
            ...
            if(check_mod($file_permission, 2) && (Auth::env("AREA_VGALLERY_DIR_SHOW_ADDNEW") || Auth::env("AREA_VGALLERY_DIR_SHOW_MODIFY") || Auth::env("AREA_VGALLERY_DIR_SHOW_DELETE") || Auth::env("AREA_PROPERTIES_SHOW_MODIFY") || Auth::env("AREA_ECOMMERCE_SHOW_MODIFY") || Auth::env("AREA_SETTINGS_SHOW_MODIFY"))) {
