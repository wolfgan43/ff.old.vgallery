<?php
	...
	if(is_file(FF_THEME_DISK_PATH . "/" . $cm->oPage->getTheme() . "/conf/restricted." . FF_PHP_EXT))
		require_once(FF_THEME_DISK_PATH . "/" . $cm->oPage->getTheme() . "/conf/restricted." . FF_PHP_EXT);    
