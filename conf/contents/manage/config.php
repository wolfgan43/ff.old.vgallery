<?php
	...
	$ff_global_setting["ffGrid"]["default_records_per_page"] = 12;
	$ff_global_setting["ffGrid"]["default_nav_selector_elements"] = array(12, 25, 50);
	...
	if(is_file(FF_THEME_DISK_PATH . "/" . $cm->oPage->getTheme() . "/conf/manage." . FF_PHP_EXT))
		require_once(FF_THEME_DISK_PATH . "/" . $cm->oPage->getTheme() . "/conf/manage." . FF_PHP_EXT);    
