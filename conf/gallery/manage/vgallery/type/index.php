...
$oGrid->display_delete_bt = Auth::env("AREA_VGALLERY_TYPE_SHOW_MODIFY") && !$simple_interface;
$oGrid->display_new = Auth::env("AREA_VGALLERY_TYPE_SHOW_MODIFY") && !$simple_interface;
