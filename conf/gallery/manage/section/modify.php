...
$oRecord->populate_edit_SQL = "SELECT layout_location.*
									...
									WHERE layout_location.ID = " . $db_gallery->toSql($_REQUEST["keys"]["ID"], "Number");
...
$oField->actex_dialog_url = FF_SITE_PATH . VG_SITE_ADMIN . "/layout/section/layer/modify"; //"?template=" . $ID_template;
...
//if(check_function("set_fields_grid_system"))
	//set_fields_grid_system($oRecord, null, $framework_css);


 /*
$oField = ffField::factory($cm->oPage);
$oField->id = "interface_level";
$oField->label = ffTemplate::_get_word_by_code("section_modify_interface_level");
$oField->base_type = "Number";
$oRecord->addContent($oField);    */
