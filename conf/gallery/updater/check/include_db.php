...
//  $db_include["locations"]["loc_stati"] = array("rel" => array(), "data" => "", "key" => array(), "compare" => array());
  ...
  $db_include["basic"]["layout_type_old"] = array("rel" => array(), "data" => "", "key" => array("ID" => true, "name" => true), "compare" => array());
  ...
  $db_include["basic"]["vgallery_type"] = array("rel" => array(), "data" => "`name` IN('Directory')", "key" => array("ID" => true, "name" => true), "compare" => array("ID" => true, "name" => true, "is_dir_default" => true, "sort_default" => true, "sort_method_default" => true), "operation" => array("insert" => true, "update" => true, "delete" => true));
