...
$oRecord->title = ffTemplate::_get_word_by_code("form_fields_title"); 
$oRecord->src_table = "module_form_fields";
$oRecord->insert_additional_fields["ID_module"] = new ffData($_REQUEST["keys"]["formcnf-ID"], "Number");
...
} else 
{
	...
	*/
	...
	$query_string = "SELECT nameID, name, type, group_name
	    ...
	    if($db_gallery->nextRecord()) {
	        $ecommerce_type = $db_gallery->getField("enable_ecommerce", "Text", true);
	        $enable_ecommerce_weight = $db_gallery->getField("enable_ecommerce_weight", "Number", true);
	        $enable_dynamic_cart_advanced = $db_gallery->getField("enable_dynamic_cart_advanced", "Number", true);
			$field_enable_dep = $db_gallery->getField("field_enable_dep", "Number", true);
			$field_enable_pricelist = $db_gallery->getField("field_enable_pricelist", "Number", true);

		$fields["group"] = $db_gallery->getField("field_default_ID_form_fields_group", "Text", true);
		$fields["extended_type"] = $db_gallery->getField("field_default_ID_extended_type", "Text", true);
		$fields["disable_free_input"] = $db_gallery->getField("field_default_disable_free_input", "Text", true);
		$fields["disable_select_one"] = $db_gallery->getField("field_default_disable_select_one", "Text", true);
		$fields["require"] = $db_gallery->getField("field_default_require", "Text", true);
		$fields["hide_label"] = $db_gallery->getField("field_default_hide_label", "Text", true);
		$fields["placeholder"] = $db_gallery->getField("field_default_placeholder", "Text", true);
		$fields["control"] = $db_gallery->getField("field_default_ID_check_control", "Text", true);
		$fields["unic_value"] = $db_gallery->getField("field_default_unic_value", "Text", true);
		$fields["send_mail"] = $db_gallery->getField("field_default_send_mail", "Text", true);
		$fields["enable_in_mail"] = $db_gallery->getField("field_default_enable_in_mail", "Text", true);
		$fields["enable_in_grid"] = $db_gallery->getField("field_default_enable_in_grid", "Text", true);
		$fields["enable_in_menu"] = $db_gallery->getField("field_default_enable_in_menu", "Text", true);
		$fields["enable_in_document"] = $db_gallery->getField("field_default_enable_in_document", "Text", true);
		$fields["enable_tip"] = $db_gallery->getField("field_default_enable_tip", "Text", true);
		$fields["writable"] = $db_gallery->getField("field_default_writable", "Text", true);
		$fields["hide"] = $db_gallery->getField("field_default_hide", "Text", true);
		$fields["preload_by_domclass"] = $db_gallery->getField("field_default_preload_by_domclass", "Text", true);
		$fields["fixed_pre_content"] = $db_gallery->getField("field_default_fixed_pre_content", "Text", true);
		$fields["fixed_post_content"] = $db_gallery->getField("field_default_fixed_post_content", "Text", true);
		$fields["vgallery_field"] = $db_gallery->getField("field_default_vgallery_field", "Text", true);
		$fields["preload_by_db"] = $db_gallery->getField("field_default_preload_by_db", "Text", true);
		$fields["domclass"] = $db_gallery->getField("field_default_domclass", "Text", true);
		$fields["custom"] = $db_gallery->getField("field_default_custom", "Text", true);

		$fields["val_min"] = $db_gallery->getField("field_default_val_min", "Text", true);        
		$fields["val_max"] = $db_gallery->getField("field_default_val_max", "Text", true);        
		$fields["val_step"] = $db_gallery->getField("field_default_val_step", "Text", true);

		$fields["qta"] = $db_gallery->getField("fixed_cart_qta", "Number", true);
		$fields["price"] = $db_gallery->getField("fixed_cart_price", "Number", true);
		$fields["vat"] = $db_gallery->getField("fixed_cart_vat", "Number", true);
		$fields["weight"] = $db_gallery->getField("fixed_cart_weight", "Number", true);
		$fields["hide_vat"] = $db_gallery->getField("hide_vat", "Number", true);
		$fields["hide_weight"] = $db_gallery->getField("hide_weight", "Number", true);

		$fields["show_price_in_label"] = $db_gallery->getField("field_default_show_price_in_label", "Text", true);
   ...
   /*
    ...
    if(check_function("get_field_default"))
        $arrFieldData = get_field_default("module_form_fields", $copy_field, "module_form_fields", $_REQUEST["keys"]["formcnfield-ID"], $field_default);
    ...
    if($_REQUEST["keys"]["formcnfield-ID"] > 0) 
    { 
...
/*
	if($copy_field > 0) 
	{
		...
		$sSQL = "SELECT module_form_fields.* 
					FROM module_form_fields
					WHERE module_form_fields.ID = " . $db_gallery->toSql($copy_field, "Number");
		$db_gallery->query($sSQL);
		if($db_gallery->nextRecord()) {	
			$field_default["ID_form_fields_group"] 		= $db_gallery->getField("ID_form_fields_group", "Number", true);
			$field_default["type"] 						= $db_gallery->getField("type", "Text", true);
			$field_default["ID_extended_type"] 			= $db_gallery->getField("ID_extended_type", "Number", true);
			$field_default["selectionSource"]			= $db_gallery->getField("ID_vgallery_field", "Number", true);
			$field_default["field"]						= $db_gallery->getField("field", "Text", true);
			$field_default["ID_vgallery_field"] 		= $db_gallery->getField("ID_vgallery_field", "Number", true);
			$field_default["disable_free_input"] 		= $db_gallery->getField("disable_free_input", "Number", true);
			$field_default["disable_select_one"] 		= $db_gallery->getField("disable_select_one", "Number", true);
			$field_default["price"] 					= $db_gallery->getField("price", "Number", true);
			$field_default["vat"] 						= $db_gallery->getField("vat", "Number", true);
			$field_default["weight"] 					= $db_gallery->getField("weight", "Number", true);
			$field_default["show_price_in_label"] 		= $db_gallery->getField("show_price_in_label", "Number", true);
			$field_default["val_min"]					= $db_gallery->getField("val_min", "Number", true);
			$field_default["val_max"] 					= $db_gallery->getField("val_max", "Number", true);
			$field_default["val_step"] 					= $db_gallery->getField("val_step", "Number", true);
			$field_default["ID_check_control"]			= $db_gallery->getField("ID_check_control", "Number", true);
			$field_default["send_mail"]					= $db_gallery->getField("send_mail", "Number", true);
			$field_default["require"] 					= $db_gallery->getField("require", "Number", true);
			$field_default["hide_label"] 				= $db_gallery->getField("hide_label", "Number", true);
			$field_default["placeholder"] 				= $db_gallery->getField("placeholder", "Number", true);
			...
			$field_default["preload_by_domclass"] 		= $db_gallery->getField("preload_by_domclass", "Text", true);
			$field_default["fixed_pre_content"] 		= $db_gallery->getField("fixed_pre_content", "Text", true);
			$field_default["fixed_post_content"] 		= $db_gallery->getField("fixed_post_content", "Text", true);
			$field_default["preload_by_db"] 			= $db_gallery->getField("preload_by_db", "Text", true);
			$field_default["domclass"] 					= $db_gallery->getField("domclass", "Text", true);
			$field_default["custom"] 					= $db_gallery->getField("custom", "Text", true);
	...
	if($_REQUEST["keys"]["formcnfield-ID"] > 0) 
	{
		$sSQL = "SELECT module_form_fields.* 
				FROM module_form_fields 
				WHERE module_form_fields.ID = " . $db_gallery->toSql($_REQUEST["keys"]["formcnfield-ID"], "Number");
		$db_gallery->query($sSQL);
		if($db_gallery->nextRecord()) {
			...
			$actual_type = $db_gallery->getField("type", "Text", true);
...
*/
	...
	if(strlen($ecommerce_type))
	{
		...
		if($_REQUEST["XHR_DIALOG_ID"])
			$oField->properties["onchange"] = "javascript:ff.ffPage.dialog.doRequest('" . $_REQUEST["XHR_DIALOG_ID"] . "', {'action' : 'refresh'});";
		else
			$oField->properties["onchange"] = "javascript:ff.ajax.doRequest({'action' : 'refresh'});";
	    ...
	    {       
	        ...
	        if($_REQUEST["XHR_DIALOG_ID"])
	            $oField->actex_on_change = "function(obj, old_value, action) { if(action == 'change') { ff.ffPage.dialog.doRequest('" . $_REQUEST["XHR_DIALOG_ID"] . "', {'action' : 'refresh'}); } }";
	        else
	            $oField->actex_on_change = "function(obj, old_value, action) { if(action == 'change') { ff.ajax.doRequest({'action' : 'refresh'}); } }";
	    ...
	    } else 
		{
	        ...
	        $oRecord->update_additional_fields["ID_extended_type"] = new ffData(str_replace("show_no_default_", "", $fields["extended_type"]), "Number");
	    }   
	    ...
	    if($actual_ext_type == "Selection" || $actual_ext_type == "Group" || $actual_ext_type == "Option" || $actual_type == "multiplier")
	    {
		    ...
		    //$oDetail_fields->title = ffTemplate::_get_word_by_code("form_fields_selection_title");
		    $oDetail_fields->src_table = "module_form_fields_selection_value";
		    $oDetail_fields->order_default = "ID";
		    $oDetail_fields->fields_relationship = array("ID_form_fields" => "formcnfield-ID");
			...
			if($actual_ext_type == "Number" && $enable_dynamic_cart_advanced) {
				...
				$oField->source_SQL = "		
										...
										WHERE module_form_fields.ID_module = " . $db_gallery->toSql($_REQUEST["keys"]["formcnf-ID"], "Number") . "
											...
											AND module_form_fields.ID <> " . $db_gallery->toSql($_REQUEST["keys"]["formcnfield-ID"], "Number") . "
										[AND] [WHERE]
										[HAVING]
	...
	switch($action) {
	    case "insert":
	        ...
	        if(isset($component->form_fields["copy-from"])) {
		        ffRedirect($component->parent[0]->site_path . $component->parent[0]->page_path . "/modify?field=" . $component->form_fields["copy-from"]->getValue() . "&keys[formcnf-ID]=" . $_REQUEST["keys"]["formcnf-ID"] . "&ret_url=" . urlencode($ret_url));
			}
    ...
    if(strlen($action))
    {
        ...
        switch ($action) {
            case "update":
					...
					if($field_name == "type" && $field_value->value_ori->getValue() == "pricelist")
					{
						if($field_value->getValue() != "pricelist" )
						{
							$sSQL = "DELETE
										...
										WHERE module_form_pricelist_detail.ID_form_fields = " . $db->toSql($component->key_fields["formcnfield-ID"]->getValue(), "Number");
							$db->execute($sSQL);
						}
					}
                }
                ...
                break;
			case "confirmdelete":
				if(isset($_REQUEST["keys"]["formcnfield-ID"]) && isset($_REQUEST["keys"]["formcnf-ID"]))
				{
					if(check_function("MD_form_fields_delete"))
						MD_form_fields_delete($_REQUEST["keys"]["formcnf-ID"], $_REQUEST["keys"]["formcnfield-ID"]);
				}
					...
					foreach($component->recordset AS $field_selection_name => $field_selection_value)
					{
						if($field_selection_value["name"]->getValue() !== $component->recordset_ori[$field_selection_name]["name"]->getValue())
						{
							$sSQL = "UPDATE module_form_pricelist_detail
										...
										WHERE module_form_pricelist_detail.ID_form_fields = " . $db->toSql($_REQUEST["keys"]["formcnfield-ID"], "Number") . "
...
function FormConfigFieldSelectionModify_on_before_parse_row($component)
{
    ...
    if(isset($component->detail_buttons["module_form_dep"])) {
        ...
        if($_REQUEST["XHR_DIALOG_ID"]) {
            $component->detail_buttons["module_form_dep"]["obj"]->jsaction = "javascript:ff.ffPage.dialog.doRequest('[[XHR_DIALOG_ID]]', {'action': 'set_dep', fields: [], 'url' : '[[frmAction_url]]'});";
        } else {
            $component->detail_buttons["module_form_dep"]["obj"]->jsaction = "javascript:ff.ajax.doRequest({'action': 'set_dep', fields: [], 'url' : '[[frmAction_url]]'});";
        }
    }
}
