ff.cms.fn.menudropdown = function(targetid) {
	/*css*/
	...
	jQuery(targetid + ".menudropdown > li").bind('mouseover', that.menu_open);
	jQuery(targetid + ".menudropdown > li").bind('mouseout',  that.menu_timer);
