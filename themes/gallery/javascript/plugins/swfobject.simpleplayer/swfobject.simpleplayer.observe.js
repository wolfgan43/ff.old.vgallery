ff.cms.fn.simpleplayer = function(targetid) {
    ...
    ff.pluginLoad("swfobject", "/themes/library/swfobject/swfobject.js", function () {
        jQuery(targetid + ".simpleplayer").each(function(){
			...
			flashvars.xmlPath = "/themes/library/plugins/swfobject.simpleplayer/player/xml/settings.xml";
			...
			/** EMBED THE SWF**/
			swfobject.embedSWF("/themes/library/plugins/swfobject.simpleplayer/preview.swf" + cacheBuster, attributes.id, stageW, stageH, "9.0.124", "/themes/library/plugins/swfobject.simpleplayer/js/expressInstall.swf", flashvars, params);
        });
    }, false);  
};