ff.cms.fn.dynatree = function(targetid) {
	...
	ff.pluginLoad("jquery.cookie", "/themes/library/plugins/jquery.cookie/jquery.cookie.js", function() {
		ff.pluginLoad("jquery.dynatree", "/themes/library/plugins/jquery.dynatree/jquery.dynatree.js", function() {
		    ...
		    jQuery(targetid + "link[href*='/jquery.dynatree/src/skin']").attr("href", ff.site_path + "/themes/library/plugins/jquery.dynatree/" + jQuery(targetid + ".dynatree").parent().attr("class").replace("menu ", "") + "/ui.dynatree.css");
		    ...
		    jQuery(targetid + ".dynatree").parent().dynatree({
				...
				imagePath: ff.site_path + "/themes/library/plugins/jquery.dynatree/src/" + jQuery(targetid + ".dynatree").parent().attr("class").replace("menu ", "") + "/", /* Path to a folder containing icons. Defaults to 'skin/' subdirectory. */
