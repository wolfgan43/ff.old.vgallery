...
$oGrid->id = "nationCity";
$oGrid->title = ffTemplate::_get_word_by_code("nation_city_title");
$oGrid->source_SQL = "SELECT " . FF_PREFIX . "loc_city.*
						FROM " . FF_PREFIX . "loc_city
							INNER JOIN " . FF_PREFIX . "loc_province ON " . FF_PREFIX . "loc_province.sigle = " . FF_PREFIX . "loc_city.sigle_province
...
$oField->label = ffTemplate::_get_word_by_code("nation_city_minor_island");
$oField->base_type = "Number";
$oField->extended_type = "Selection";
$oField->multi_pairs = array (
                            array(new ffData("", "Number"), new ffData(ffTemplate::_get_word_by_code("no"))),
