...
$oRecord->id = "NationProvinceModify";
$oRecord->resources[] = $oRecord->id;
$oRecord->title = ffTemplate::_get_word_by_code("nation_province_title");
$oRecord->src_table = FF_PREFIX . "loc_province";
...
$oField = ffField::factory($cm->oPage);
$oField->id = "ID_state";
$oField->label = ffTemplate::_get_word_by_code("nation_province_ID_state");
$oField->base_type = "Number";
$oField->widget = "actex";
//$oField->widget = "activecomboex";
$oField->actex_update_from_db = true;
$oField->source_SQL = "SELECT " . FF_PREFIX . "loc_state.ID
							, " . FF_PREFIX . "loc_state.name
						FROM
							" . FF_PREFIX . "loc_state
						ORDER BY " . FF_PREFIX . "loc_state.name
						";
$oRecord->addContent($oField);
